...
namespace Shop_EPR
{
    public partial class frmJiZhangLuru : DockContent
    {
        ...
        string guidangren;
        List<clsFAinfo> OrderResults;
        public frmJiZhangLuru(string username)
        {
            InitializeComponent();
        ...
        private void btbew_Click(object sender, EventArgs e)
        {
            ...
            var form = new frmAddZongDianXianjinliu("create", null, guidangren);
        ...
        private void dataGridView1_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (column == editColumn1)
            {
                ...
                var model = row.DataBoundItem as clsFAinfo;

                var form = new frmAddZongDianXianjinliu("Edit", model, guidangren);
        ...
        private void InitializeDataSource()
        {
            ...
            OrderResults = BusinessHelp.findOrder_Server(this.keywordTextBox.Text, start_time, end_time, jigoudaima, zhifufangshi);

            var maichanglist = this.OrderResults.FindAll(o => o.R_id != null);
            var distinctProduct = maichanglist.Distinct(new IdComparer());
            OrderResults = new List<clsFAinfo>();
            OrderResults = distinctProduct.ToList();

            //if (Result)
            this.dataGridView1.AutoGenerateColumns = false;
            sortablePendingOrderList = new SortableBindingList<clsFAinfo>(OrderResults);
        ...
        private void toolStripButton2_Click(object sender, EventArgs e)
        {
            if (comboBox1.Text != null && comboBox1.Text.Length > 0)
            {
                ...
                if (MessageHelper.DeleteConfirm(msg))
                {
                    ...
                    BusinessHelp.delete_ZongDianFenDianServer(comboBox1.Text);
                    BeginActive();
                }
            }
            else
