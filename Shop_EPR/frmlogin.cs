...
namespace Shop_EPR
{
    public partial class frmlogin : Form
    {
        ...
        private frmJiZhangLuru frmJiZhangLuru;
        private frmFenDianJiZhangLuru frmFenDianJiZhangLuru;
        public frmlogin()
        {
            InitializeComponent();
            InitialSystemInfo();
            ...
            this.Text = "PT 总店财务管理系统 " + System.Reflection.Assembly.GetExecutingAssembly().GetName().Version.ToString();
        ...
        private void tsbLogin_Click(object sender, EventArgs e)
        {
            ...
            DateTime dt2;
            dt2 = Convert.ToDateTime("2017/08/05");
        ...
        {
            if (frmJiZhangLuru == null)
            {
                frmJiZhangLuru = new frmJiZhangLuru(this.txtSAPUserId.Text.Trim());
                frmJiZhangLuru.FormClosed += new FormClosedEventHandler(FrmOMS_FormClosed);
            }
            if (frmJiZhangLuru == null)
            {
                frmJiZhangLuru = new frmJiZhangLuru(this.txtSAPUserId.Text.Trim());
            }
            frmJiZhangLuru.Show(this.dockPanel2);
        }

        void FrmOMS_FormClosed(object sender, FormClosedEventArgs e)
        {
            if (sender is frmJiZhangLuru)
            {
                frmJiZhangLuru = null;
            }


            if (sender is frmFenDianJiZhangLuru)
            {
                frmFenDianJiZhangLuru = null;
            }
        ...
        {
            if (frmFenDianJiZhangLuru == null)
            {
                frmFenDianJiZhangLuru = new frmFenDianJiZhangLuru(this.txtSAPUserId.Text.Trim());
                frmFenDianJiZhangLuru.FormClosed += new FormClosedEventHandler(FrmOMS_FormClosed);
            }
            if (frmFenDianJiZhangLuru == null)
            {
                frmFenDianJiZhangLuru = new frmFenDianJiZhangLuru(this.txtSAPUserId.Text.Trim());
            }
            frmFenDianJiZhangLuru.Show(this.dockPanel2);
        }
